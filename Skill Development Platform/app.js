...
if (closeFeedbackFormBttn)
  closeFeedbackFormBttn.addEventListener("click", hideFeedbackForm);
...
if (manageYourAccountDIv)
  manageYourAccountDIv.addEventListener("click", showupdateForm);
...
if (closeUpdateDivBttn)
  closeUpdateDivBttn.addEventListener("click", hideUpdateForm);
...
loginButton.addEventListener("click", (e) => {
  ...
  if (username === "Rohit" && password === "test@gmail.com") {
...
if (SwitchtoSignUp)
  SwitchtoSignUp.addEventListener("click", switchToSignUpFrom);
...
function updatefrom(event) {
  ...
  let updateConfirmPassword = document.getElementById(
